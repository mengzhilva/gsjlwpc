...
foreach($mystory as $k=>$v){?>
		...
		<div class="ttitle"><a href="<?php echo site_url('story/main/show_story/m/showstory/'.$v["sid"]); ?>" ><?php echo $v['title']?></a></div>
		<?php }else{?>
		<div ><a href="<?php echo site_url('story/main/show_story/m/showstory/'.$v["sid"]); ?>" ><?php echo $v['content']?></a></div>
		<?php } ?>
		
           	 <div class="story_info_all"><span>作者：</span><span><?php echo $v['username'] ?></span>
            <span>时间：</span><span><?php echo $v['create_date'] ?></span></div>
		<div ><a style="font-size:12px;color:#333" href="<?php echo site_url('story/main/show_story/m/showstory/'.$v["sid"]); ?>" >
