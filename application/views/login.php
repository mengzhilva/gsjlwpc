...
<tr>
<td height="30" valign="top"  align="right"><a href="<?php echo site_url('/story/main/zhuce');?>" id="loginbtn">注册</a></td>
<td height="30" valign="top"  align="right" style="width:120px !important;"><a href="javascript:void(0)" onclick="login()" id="loginbtn"><?=lang('btn_login')?></a></td>
</tr>
