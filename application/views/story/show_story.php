...
<div id="myreplybox" class="myreplybox">
	...
	<div class="ainput" style="width:260px">
	 <div class="atitle"  style="width:60px">验证码：</div>
		    ...
		    <img  id="yzmimg" class="yzm" src="<?php echo base_url().'code.php';?>" alt="" onclick= this.src="<?php echo base_url().'/code.php/';?>"+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。"/>
		    </div>
	</div>
	<div style="width:200px;margin:0 auto;padding-top:15px;">
